...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-pulumi-signalfx-synthetics
  dir: provider
  goarch:
  - amd64
  - arm64
...
├── config.yaml
├── metadata.json
├── pulumi-pulumi-signalfx-synthetics_darwin_amd64_v1
│   └── pulumi-resource-pulumi-signalfx-synthetics
├── pulumi-pulumi-signalfx-synthetics_darwin_arm64
│   └── pulumi-resource-pulumi-signalfx-synthetics
├── pulumi-pulumi-signalfx-synthetics_linux_amd64_v1
│   └── pulumi-resource-pulumi-signalfx-synthetics
├── pulumi-pulumi-signalfx-synthetics_linux_arm64
│   └── pulumi-resource-pulumi-signalfx-synthetics
├── pulumi-pulumi-signalfx-synthetics_windows_amd64_v1
│   └── pulumi-resource-pulumi-signalfx-synthetics.exe
└── pulumi-pulumi-signalfx-synthetics_windows_arm64
    └── pulumi-resource-pulumi-signalfx-synthetics.exe
```
