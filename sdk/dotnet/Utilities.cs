...
namespace Pulumi.Synthetics
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/Displayr/pulumi-signalfx-synthetics/releases/download/v0.0.11/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Synthetics.version.txt");
    ...
    internal sealed class SyntheticsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SyntheticsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
